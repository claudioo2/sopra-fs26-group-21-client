...
| **Student**        | **Date** | **Link to Commit** | **Description**                 | **Relevance**                       |
| ------------------ | -------- | ------------------ | ------------------------------- | ----------------------------------- |
| **GabrielVuattoux** | [date]   | [Link to Commit 1] | Upon successful creation, the event is saved to the database and the pointer immediately appears on the map for all users | important for the overview and for the database format |
